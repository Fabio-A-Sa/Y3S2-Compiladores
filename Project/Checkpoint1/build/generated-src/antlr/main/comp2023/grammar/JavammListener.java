...
public interface JavammListener extends ParseTreeListener {
	 ...
	 * @param ctx the parse tree
	 */
	void enterArrayAssign(JavammParser.ArrayAssignContext ctx);
	/**
	 * Exit a parse tree produced by the {@code ArrayAssign}
	 * labeled alternative in {@link JavammParser#statement}.
	 * @param ctx the parse tree
	 */
	void exitArrayAssign(JavammParser.ArrayAssignContext ctx);
	/**
	 ...
	 * @param ctx the parse tree
	 */
	void enterArraySubscript(JavammParser.ArraySubscriptContext ctx);
	/**
	 * Exit a parse tree produced by the {@code ArraySubscript}
	 * labeled alternative in {@link JavammParser#expression}.
	 * @param ctx the parse tree
	 */
	void exitArraySubscript(JavammParser.ArraySubscriptContext ctx);
	/**
