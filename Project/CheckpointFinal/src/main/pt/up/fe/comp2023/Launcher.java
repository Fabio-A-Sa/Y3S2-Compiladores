...
public class Launcher {
    ...
    public static void main(String[] args) {
        ...
        // Optimization stage
        MyJmmOptimizer optimization = new MyJmmOptimizer();
        jmmSemanticsResult = optimization.optimize(jmmSemanticsResult);
        if (jmmSemanticsResult.getReports().size() > 0) {                               // Check optimization errors
            for (Report report : jmmSemanticsResult.getReports())
                System.out.println(report.toString());
            return;
        }
        ...
        // Compile and run Jasmin Code
        System.out.println("Output:");
        jmmJasminResult.compile();
        jmmJasminResult.run();
    }
